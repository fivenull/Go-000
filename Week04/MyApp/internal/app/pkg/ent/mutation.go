...
// OldBody returns the old body value of the Article.
// If the Article object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
...
// Published returns the published value in the mutation.
...
// OldPublished returns the old published value of the Article.
// If the Article object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *ArticleMutation) OldPublished(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldPublished is allowed only on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetPublished reset all changes of the "published" field.
func (m *ArticleMutation) ResetPublished() {
	m.published = nil
}

// SetCreatedTime sets the created_time field.
func (m *ArticleMutation) SetCreatedTime(t time.Time) {
	m.created_time = &t
}

// CreatedTime returns the created_time value in the mutation.
func (m *ArticleMutation) CreatedTime() (r time.Time, exists bool) {
	v := m.created_time
	if v == nil {
		return
	}
...
// OldCreatedTime returns the old created_time value of the Article.
// If the Article object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *ArticleMutation) OldCreatedTime(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ArticleMutation) ResetCreatedTime() {
	m.created_time = nil
}
...
func (m *ArticleMutation) Fields() []string {
	...
	if m.created_time != nil {
		fields = append(fields, article.FieldCreatedTime)
	}
	return fields
}
