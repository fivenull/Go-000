...
// First returns the first Article entity in the query. Returns *NotFoundError when no article was found.
...
// FirstID returns the first Article id in the query. Returns *NotFoundError when no id was found.
